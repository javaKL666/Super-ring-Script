...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    ToggleButton.Text = ringPartsEnabled and "黑洞 开" or "黑洞 关"
...
SendChatMessage("Super Ring V6 by TheHunterSolo1")